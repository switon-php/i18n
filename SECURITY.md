...
Security fixes are provided for **currently supported release lines** of `switon/i18n` (`switon/i18n` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/i18n/security/advisories/new)
